...
function activate(context) {
    ...
    const provideCustomEnter = vscode.commands.registerTextEditorCommand('ms.customEnter', (textEditor, edit) => {
    ...
    const provideCustomBackspace = vscode.commands.registerTextEditorCommand('ms.customBackspace', (textEditor, edit) => {
        const document = textEditor.document;
